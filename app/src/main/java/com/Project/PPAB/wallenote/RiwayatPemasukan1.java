...
public class RiwayatPemasukan1 extends AppCompatActivity {
    DBHelper dbcenter;
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_riwayat_pemasukan);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent n = new Intent(RiwayatPemasukan1.this, LihatCatatan.class);
